/* =====================================================================
   Grand Horizon Hotel ERP — Sample / Demo Data
   Run AFTER schema.sql. All demo users share the password: Password123
   (bcrypt hash below is valid for PHP password_verify()).
   ===================================================================== */
...
DECLARE @hash VARCHAR(255) = '$2b$10$yKvAWGaj4eMfPF48v89RmOgDqynHbS9xPDMckv9PxMukhmd6CfBA6';

INSERT INTO Users (FullName, Email, Username, PasswordHash, RoleID, IsActive) VALUES
('Aisha Perera',    'admin@grandhorizon.test',       'admin',       @hash, 1, 1),
('Kasun Fernando',  'manager@grandhorizon.test',     'manager',     @hash, 2, 1),
('Nadeesha Silva',  'frontdesk@grandhorizon.test',   'frontdesk1',  @hash, 3, 1),
('Ruwan Jayasuriya','housekeeping@grandhorizon.test','housekeep1',  @hash, 4, 1),
('Dilani Rathnayake','finance@grandhorizon.test',    'finance1',    @hash, 5, 1);
GO
