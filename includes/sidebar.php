...
$navItems = [
    ...
    ['label' => 'Inventory', 'icon' => 'bi-box-seam', 'url' => '/modules/inventory/list.php', 'match' => 'inventory', 'roles' => ['Admin','Manager','Finance']],
    ['label' => 'Suppliers & POs', 'icon' => 'bi-truck', 'url' => '/modules/inventory/suppliers.php', 'match' => 'inventory', 'roles' => ['Admin','Manager','Finance']],
    ...
    ['label' => 'Audit Log', 'icon' => 'bi-shield-check', 'url' => '/modules/users/audit-log.php', 'match' => 'users', 'roles' => ['Admin']],
    ['label' => 'User Accounts', 'icon' => 'bi-person-gear', 'url' => '/modules/users/list.php', 'match' => 'users', 'roles' => ['Admin']],
];
?>
<nav class="app-sidebar" id="appSidebar">
  ...
  <ul class="app-sidebar-nav">
    <?php foreach ($navItems as $item): ?>
      ...
      <?php $active = ($currentDir === $item['match'] || $current === $item['match']); ?>
      <li>
